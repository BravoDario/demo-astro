...
export function CounterDown({ dias, horas, minutos, segundos }) {
  ...
  return (
    <div className='text-black bg-transparent bg-opacity-50 backdrop-blur-sm flex text-center md:grid md:grid-cols-2 md:text-left lg:flex lg:text-center justify-center gap-6 text-md md:text-3xl font-semibold py-5 px-0 sm:px-5 md:px-8 lg:px-2 xl:px-8 border rounded-lg'>
      <div>
